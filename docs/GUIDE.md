...
> **Welcome to Service-Track Week 10, Task 3!**
...
| `src/reportUtils.py` | Main source code - **has bugs to fix** |
| `src/salesReporter.py` | Supporting code - **may also have bugs** |
| `tests/test_reports.py` | Test file - **add your tests here** |
...
### Incident - `src/salesReporter.py`
**User Report / Alert:**
> "Uses LEFT JOIN — includes customers with no orders (Diana)"
...
### Incident - `src/salesReporter.py`
**User Report / Alert:**
> "Doesn't filter out cancelled orders"
...
### Incident - `src/salesReporter.py`
**User Report / Alert:**
> "Uses CROSS JOIN instead of proper JOIN"
...
### Incident - `src/salesReporter.py`
**User Report / Alert:**
> "strftime format wrong — uses %Y-%M instead of %Y-%m"
